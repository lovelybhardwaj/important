...
class Transformer(nn.Module):
    ...
    def forward(self, src, query_embed, y_ind):
        ...
        bs, c, h, w = src.shape
        #The source sequence is flattened and transformed to the shape (HW, N, C),
        #where HW is the product of height and width, N is the batch size, and C is the number of channels.
